...
public interface UserInformationRepository extends JpaRepository<UserInformation, Integer> {
	...
	public int update(@Param("dateOfBirth") Date dateOfBirth,@Param("email") String email,@Param("gender") String gender, @Param("height") double height,@Param("name") String name,
			@Param("password") String password, @Param("referalCode") String referalCode,@Param("weight") double weight,@Param("userId") int userId, @Param("photo") String photo);
