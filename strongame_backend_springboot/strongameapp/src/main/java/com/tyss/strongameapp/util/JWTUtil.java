...
public class JWTUtil  implements Serializable{
	...
	public String generateTokenRegister(UserInformationDto user) {
		Map<String, Object> claims = new HashMap<>();
		return doGenerateToken(claims, user.getEmail());
	}

	public String generateTokenLogin(UserInformation userEntity) {
		Map<String, Object> claims = new HashMap<>();
		return doGenerateToken(claims, userEntity.getEmail());
	}

	public String generateTokenTroughNumber(String emailOrNumber) {
		Map<String, Object> claims = new HashMap<>();
		return doGenerateToken(claims, emailOrNumber);	}
}
